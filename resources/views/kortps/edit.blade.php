...
@section('content')
    ...
    <div class="data">
        <div class="content-data">
            <div class="container">
                <h1 class="text-center"> Edit Koordinator TPS</h1>
                <form action="{{ route('kortps/update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6 mt-3">
                            ...
                            <select class="form-select" id="korhan_id" name="korhan_id" aria-label="Default select example">
                                <option value="{{$data->korhan_id}}" selected>{{$data->korhans->nama_koordinator}}</option>
                        ...
                        <div class="col-sm-6 mt-3 mb-3">
                            ...
                            <select class="form-select mt-3 mb-3" id="tps_id" name="tps_id[]" multiple="multiple">
                                @foreach ($tps as $item)
                                    <option value="{{ $item->id }}"
                                        {{ in_array($item->id, old('tps_id', $data->tps_pivot->pluck('id')->toArray())) ? 'selected' : '' }}>
