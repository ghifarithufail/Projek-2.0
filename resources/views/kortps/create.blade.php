            ...
            <form action="{{ route('kortps/store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mt-4">
                        ...
                        <div class="form-group">
                            <select class="tpsrw_id form-select" name="tps_id[]" id="tps_id" aria-label="Default select example" multiple="multiple">
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6 mt-4">
                        ...
                        <div class="form-group">
                            <select class="tpsrw_id form-select" name="korhan_id" id="korhan_id" aria-label="Default select example">
