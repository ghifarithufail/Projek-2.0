    ...
    <div class="data">
        <div class="content-data">
            <div class="container">
                ...
                <form action="{{ route('korhan/update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6 mt-3 mb-3">
                            ...
                            <select class="form-select mt-3 mb-3" id="tps_id" name="tpshan_id[]" multiple="multiple">
                                @foreach ($tps as $item)
                                    <option value="{{ $item->id }}"
                                        {{ in_array($item->id, old('tpshan_id', $data->pivot_korhans->pluck('id')->toArray())) ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-6 mt-3">
                            <label class="form-label">Koordinator Kecamatan</label>
                            <select class="form-select" id="korcam_id" name="korcam_id" aria-label="Default select example">
                                <option value="{{$data->korcam_id}}" selected>{{$data->koordinators->nama_koordinator}}</option>
                            </select>
                        </div>
