  ...
  <body>
    ...
    <div class="data mb-5">
        <div class="content-data">
            <h1 style="text-align: center; text-transform: uppercase;">KOORDINATOR KELURAHAN : {{$item->nama_koordinator}}</h1>
        </div>
    </div>
            ...
            <div>
                <div>
                    <div class="mb-3" style="display: inline-block; margin-right: 20px;">
                        <b>Korcam : {{$item->koordinators->nama_koordinator}}</b>
                    </div>
                    <div class="mb-3" style="display: inline-block;">
                        <b>Jumlah Kor-tps : {{$jumlahKortps}}</b>
                    </div>
                    <div class="mb-3" style="display: inline-block;">
                        <b>Konstituante : {{$jumlahKonstituante}}</b>
                    </div>
                </div>
                <table class="table" style="zoom: 0.6">
                    <thead>
                        <tr>
