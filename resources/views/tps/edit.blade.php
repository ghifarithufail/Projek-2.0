            ...
            <form action="{{ route('tps/update', $tps->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="form-group">
                            <select class="kelurahan_id form-select" name="kelurahan_id" id="kelurahan_id"
                                ...
                                <option value="{{ $tps->kelurahan_id }}" selected> --
                                    {{ $tps->kelurahans->nama_kelurahan }} --</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="form-group">
                            <input id="nik" name="tps" type="text" value="{{ $tps->tps }}" class="form-control">
                        </div>
                        @error('tps')
                    ...
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="form-group">
                            <input id="nik" name="totdpt" type="text" value="{{ $tps->totdpt }}" class="form-control">
                        </div>
                        @error('totdpt')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="form-group">
                            <input id="nik" name="dptl" type="text" value="{{ $tps->dptl }}" class="form-control">
                        </div>
                        @error('dptl')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="form-group">
                            <input id="nik" name="dptp" type="text" value="{{ $tps->dptp }}" class="form-control">
                        </div>
                        @error('dptp')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="form-group">
                            <input id="nik" name="lokasi" type="text" value="{{ $tps->lokasi }}" class="form-control">
                        </div>
                        @error('lokasi')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="form-group">
                            <input id="nik" name="target" type="text" value="{{ $tps->target }}" class="form-control">
                        </div>
                        @error('target')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
